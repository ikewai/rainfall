...
wget https://ikeauth.its.hawaii.edu/files/v2/download/public/system/ikewai-annotated-data/HCDP/workflow_data/preliminary/rainfall/working_data/hads/"$(date --date="yesterday" +"%Y_%m")_hads_daily_rf.csv" -P /home/hawaii_climate_products_container/preliminary/rainfall/working_data/hads/
wget https://ikeauth.its.hawaii.edu/files/v2/download/public/system/ikewai-annotated-data/HCDP/workflow_data/preliminary/rainfall/working_data/madis/"$(date --date="yesterday" +"%Y_%m")_madis_daily_rf.csv" -P /home/hawaii_climate_products_container/preliminary/rainfall/working_data/madis/
wget https://ikeauth.its.hawaii.edu/files/v2/download/public/system/ikewai-annotated-data/HCDP/workflow_data/preliminary/rainfall/working_data/nws_rr5/"$(date --date="yesterday" +"%Y_%m")_nws_daily_rf.csv" -P /home/hawaii_climate_products_container/preliminary/rainfall/working_data/nws_rr5/
